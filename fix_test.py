...
code = re.sub(r"node=([a-zA-Z_0-9]+)(\s*,)", r"node=\1.model_dump()\2", code)

code = re.sub(r"ledger=([a-zA-Z_0-9]+)(\s*,)", r"ledger=\1.model_dump()\2", code)

code = re.sub(r"action_space=([a-zA-Z_0-9]+)(\s*[,)])", r"action_space=\1.model_dump()\2", code)
...
with open("tests/test_engine_reflex.py") as f:
    code = f.read()
...
with open("tests/test_engine_slicing.py") as f:
    code = f.read()
